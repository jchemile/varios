...
class Aplicacion:
    ...
    def __init__(self):
        ...
        self.ventana1= tk.Tk()
        self.label1 = ttk.Label(self.ventana1, text="Seleccione la cantida de bultos:")
    ...
    def sortear(self):
        if int(self.spinbox1.get())==0:
            mb.showerror("Cuidado", "Tiene que ser distinto de cero")
        else:
            valor = random.randint(1,3)
            if valor==1:
                self.label2.configure(text="Revisar")
