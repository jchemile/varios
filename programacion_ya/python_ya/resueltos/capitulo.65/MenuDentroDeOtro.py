...
class Aplicacion:
    ...
    def __init__(self):
        ...
        submenu1.add_command(label="1024x1024", command=self.tam1)
        submenu1.add_command(label="1280x1024", command=self.tam2)

        opciones2.add_cascade(label="Otros Tamaños", menu= submenu1)
        menubar1.add_cascade(label="Tamaños", menu=submenu1)
