...
class Aplicacion:
    ...
    def entradadatos(self):
        ...
        self.boton1=ttk.Button(self.lf1, text="Generar grafico", command=self.grafico_barra)
    ...
    def grafico_barra(self):
        ...
        self.canvas1.create_rectangle(10+largo1,200,10+largo1+largo2,260,fill="blue")
        self.canvas1.create_rectangle(10+largo1+largo2,200,10+largo1+largo2+largo3,260,fill="green")
