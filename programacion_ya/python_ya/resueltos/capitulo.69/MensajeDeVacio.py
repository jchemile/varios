...
class Aplicacion:
    ...
    def __init__(self):
        ...
        self.labelframe1=ttk.LabelFrame(self.ventana1, text="Suma de nuermos")
    ...
    def agregar_componentes(self):
        self.label1 = ttk.Label(self.labelframe1, text="Primer valor:")
        ...
        self.label2=ttk.Label(self.labelframe1, text="Segundo Valor:")
        ...
        self.boton1.grid(column=1, row=2, padx=5, pady=5, stick="we")
    ...
    def sumar(self):
        if self.dato1.get()=="" or self.dato2.get()=="":
            mb.showerror("Cuidado", "No se puede dejar ncuadro vacio")
        else:
            suma = int(self.dato1.get()) + int(self.dato2.get())
            self.ventana1.title("Suma: "+ str(suma))

    def acerca(self):
        mb.showinfo("informacion", "Aprendiendo")
