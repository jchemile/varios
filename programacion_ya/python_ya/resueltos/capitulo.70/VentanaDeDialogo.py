...
class Aplicacion:
    ...
    def agregar_menu(self):
        ...
        self.opciones1.add_command(label="Cofigurar ventana", command=self.configurar)
        self.menubar1.add_cascade(label="Opcines", menu=self.opciones1)

    def configurar(self):
        dialogo1 = DialogoTam(self.ventana1)
        s=dialogo1.mostrar()
