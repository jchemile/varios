...
int main()
{
    ...
    lg -> insertar(1, 115);
    lg -> imprimir();
    cout << "Borro primero" << endl;
    lg -> borrar(1);
    lg -> imprimir();
    cout << "Extraigo Segundo" << endl;
    lg -> extraer(2);
    lg -> imprimir();
    ...
    if(lg -> existe(20))
        ...
        cout << "No se encuentra el 20 en la lista" << endl;
    cout << "Posicion del mayor: " << lg -> posMayor() << endl;
    if(lg -> ordenada())
        cout << "Ordenada" << endl;
    else
        cout << "No ordenada" << endl;
    delete lg;
    return 0;
}
