...
int main()
{
    ...
    cout << "Luego de insertar 4 nodos al principio" << endl;
    lc -> imprimir();
    lc -> insertarUltimo(250);
    lc -> insertarUltimo(7);
    cout << "Luego de insertar 2 nodos al final" << endl;
    lc -> imprimir();
    cout << "Cantidad de nodods: " << lc -> cantidad() << endl;
    cout << "Luego de borrar el de la primera posicion: " << endl;
    lc -> borrar(1);
    lc -> imprimir();
    cout << "Luego de borrar el de la cuarta psoicion: " << endl;
    lc -> borrar(4);
    lc -> imprimir();
    delete lc;
    return 0;
