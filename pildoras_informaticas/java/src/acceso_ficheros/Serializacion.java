...
public class Serializacion {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            ObjectOutputStream escribiendo_fichero = new ObjectOutputStream(new FileOutputStream("src/acceso_ficheros/empleado.dat"));
            escribiendo_fichero.writeObject(personal);
            escribiendo_fichero.close();

            ObjectInputStream recuperando_fichero = new ObjectInputStream(new FileInputStream("src/acceso_ficheros/empleado.dat"));
